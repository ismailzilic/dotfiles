return {
    {
                    ...
                    telescope = {
                        ...
                        layout = {
                            ...
                            border = "none",
                            {
                                ...
                                { win = "input", height = 1, title = "{title} {live} {flags}", title_pos = "center", border = "rounded" },
                            },
                            {
                                win = "preview",
        ...
        keys = {
            ...
            { "<leader>dB", function() require("snacks").bufdelete() end, desc = "Delete or Colse Buffer (Confirm)" },
